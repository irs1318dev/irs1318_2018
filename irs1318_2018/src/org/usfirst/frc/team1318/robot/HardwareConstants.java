...
public class HardwareConstants
{
    ...
    public static final double ELEVATOR_INNER_MAX_HEIGHT = 39.0; // max height of the elevator
    public static final double ELEVATOR_OUTER_MAX_HEIGHT = 36.5; // max height of the elevator
